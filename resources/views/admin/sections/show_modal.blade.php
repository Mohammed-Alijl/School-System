        ...
        <div class="modal-content shadow-lg border-0" style="border-radius: 12px; overflow: hidden;">
            ...
            <div class="modal-body p-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="p-3 bg-light rounded" id="show-notes" style="min-height: 50px;">--</div>
                </div>
                ...
                <div>
                    ...
                    <div id="no-students-empty-state" class="text-center p-4 d-none bg-light rounded mt-2">
