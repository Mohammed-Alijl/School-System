        ...
        <div class="row row-sm">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="addForm" action="{{ route('admin.roles.update',$role->id) }}" method="POST" data-parsley-validate="">
                            @csrf
                            @method('PUT')
                                <div class="form-group mb-4">
                                    <label>{{__('admin.roles.fields.name')}} <span class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control" placeholder="{{__('admin.roles.fields.name_placeholder')}}" required autocomplete="off" minlength="3" maxlength="30" value="{{$role->name}}">
                                </div>
